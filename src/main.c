...
#define ISP_W0	3864
#define ISP_H0	2192
#define ISP_W	1280 //3840
#define ISP_H	720  //2160
#define ISP_F	30	//ͼ��֡��
...
FH_VOID *sample_common_get_stream_proc(FH_VOID *arg)
{
    ...
    while (*stop == 0)
    {
		...
		// ret = FH_VENC_GetStream_Timeout(FH_STREAM_ALL & (~(FH_STREAM_JPEG)), &stream,1000);
...
static int sampe_set_venc_cfg(int chan, int enc_w, int enc_h)
{
	...
	cfg_param.rc_attr.h264_cbr.bitrate				  = 2*1024*1024; //2m 2*1024*1024
	...
	cfg_param.rc_attr.h264_cbr.maxrate_percent		  = 120;
...
int sample_set_osd()
{
	...
	sprintf(text_line_cfg[2].textInfo, "Wuhan Technology");
	text_line_cfg[2].textEnable    = 1;                          /* ʹ���Զ���text */
    text_line_cfg[2].timeOsdEnable = 0;                          /* ȥʹ��ʱ����ʾ */
    text_line_cfg[2].textLineWidth = (64/2) * 36;				/* ÿ�������ʾ36�����ؿ���Ϊ32���ַ� */
    text_line_cfg[2].linePositionX = 0;                          /* ���Ͻ���ʼ���������λ�� */
    text_line_cfg[2].linePositionY = 0;                          /* ���Ͻ���ʼ��߶�����λ�� */

    text_line_cfg[2].lineId = 2;
    text_line_cfg[2].enable = 1;

	printf("\n\n\n%c\n\n\n\n\n",text_line_cfg[2].textInfo[0]);
    ...
    text_line_cfg[3].linePositionX = 0;                         
    text_line_cfg[3].linePositionY = 128;                       

    text_line_cfg[3].lineId = 3;
    text_line_cfg[3].enable = 1;

	printf("\n\n\n\n\n%c\n\n\n\n\n",text_line_cfg[3].textInfo[0]);
...
int main(int argc, char *argv[])
{
	...
	//1920 1080 更改视频分辨率
	ret = sampe_set_venc_cfg(0, 1280, 720);//���ñ���Ŀ��ߣ���Ҫ��󶨵�VPU�Ŀ���һ��
	CHECK_RET(ret != 0, ret);
	...
	stVpumaskinfo.area_value[1].u32X = 0;
	stVpumaskinfo.area_value[1].u32Y = 500;
	stVpumaskinfo.area_value[1].u32Width = 200; 
	stVpumaskinfo.area_value[1].u32Height = 200; 
